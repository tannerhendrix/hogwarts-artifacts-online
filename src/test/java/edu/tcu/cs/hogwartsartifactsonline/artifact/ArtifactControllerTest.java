...
class ArtifactControllerTest {
    ...
    void testFindAllArtifactSuccess() throws Exception {
        ...
        //When and Then
        this.mockMvc.perform(get(this.baseUrl + "/artifacts").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON).params(requestParams))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception {
        //Given
        ArtifactDto artifactDto = new ArtifactDto("1250808601744904197", "Invisibility Cloak",
        "A new description.",
        "ImageUrl",
                null);
        String json = this.objectMapper.writeValueAsString(artifactDto);
    ...
    void testDeleteArtifactSuccess() throws Exception {
        ...
        //When and Then
        this.mockMvc.perform(delete(this.baseUrl + "/artifacts/1250808601744904191").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteArtifactErrorWithNonExistentId() throws Exception {
        ...
        this.mockMvc.perform(delete(this.baseUrl + "/artifacts/1250808601744904197").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find artifact with Id 1250808601744904197 :("))
                .andExpect(jsonPath("$.data").isEmpty());
