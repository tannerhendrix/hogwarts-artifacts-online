...
class ArtifactControllerTest {
    ...
    void testFindAllArtifactSuccess() throws Exception {
        ...
        //When and Then
        this.mockMvc.perform(get("/api/v1/artifacts").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteArtifactSuccess() throws Exception {
        ...
        //When and Then
        this.mockMvc.perform(delete("/api/v1/artifacts/1250808601744904191").contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
